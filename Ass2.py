...
df_paragraph = df_data.select((explode("data.paragraphs").alias("paragraph")),'data.title')
df_qas = df_paragraph.select((explode("paragraph.qas").alias("qas")),"paragraph.context","title")
